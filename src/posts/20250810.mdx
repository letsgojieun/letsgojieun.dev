...
At first, I tried all the usual suspects—throttling, partial recalculations, render optimizations—but it quickly became clear: just "tuning around the edges" wouldn't deliver the stable, smooth UX I wanted.<br /><br />
...
## 3. The Solution: A Custom Keypad for Both Performance and UX
...
- Only calculates when you tap "Done"—cutting unnecessary re-renders and recalcs<br />
...
## 4. Impact on Performance and UX

- **Performance**: No more heavy lag when loading large datasets.<br />
- **Stability**: Fewer stray state changes → less risk of data mismatch or bugs.<br />
